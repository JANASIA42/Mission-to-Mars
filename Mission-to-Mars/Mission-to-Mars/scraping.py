# Import Splinter and BeautifulSoup, etc.
...
def scrape_all():
    ...
    news_title, news_paragraph = mars_news(browser) # sets news title and paragraph variables, tells Python to use mars_news function to pull data
...
def mars_news(browser):
    ...
    url = 'https://data-class-mars.s3.amazonaws.com/Mars/index.html' # removed --> 'https://redplanetscience.com'
    browser.visit(url)
    ...
    try:
        ...
        #??? why removed? --> slide_elem.find('div', class_='content_title')
...
def featured_image(browser):
    ...
    # Visit URL
    url = 'https://data-class-jpl-space.s3.amazonaws.com/JPL_Space/index.html' # removed --> 'https://spaceimages-mars.com'
    browser.visit(url)
    ...
    # removed --> f'https://spaceimages-mars.com/{img_url_rel}'
...
def mars_facts():
    try:
      ...
      df = pd.read_html('https://data-class-mars-facts.s3.amazonaws.com/Mars_Facts/index.html')[0]
        # removed --> ('https://galaxyfacts-mars.com')[0]
